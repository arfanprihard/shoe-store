...
const getCouriers = (req, res) => {
  return sendSuccess(res, 'Daftar kurir berhasil diambil', [
...
const calculateRates = (req, res) => {
  try {
    ...
    return sendSuccess(res, 'Perhitungan ongkir berhasil', {
    ...
    return sendError(res, 'Gagal menghitung ongkir', e, 500);
  }
};

// GET /api/shipping/track/:waybill
const trackWaybill = (req, res) => {
  ...
  return sendSuccess(res, 'Tracking resi berhasil', {
